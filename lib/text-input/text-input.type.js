...
var PropsGaea = function PropsGaea() {
    ...
    this.gaeaUniqueKey = 'gaea-text-input';
    this.gaeaEdit = ['文字', {
        field: 'text',
        label: '内容',
        editor: 'text',
        editable: true
    }, '布局', index_1.gaeaHelper.marginPaddingEditor, index_1.gaeaHelper.widthHeightEditor, index_1.gaeaHelper.overflowEditor, '特效', index_1.gaeaHelper.opacityEditor];
};
...
var Props = function (_PropsGaea) {
    ...
    function Props() {
        ...
        _this.style = (0, _extends3.default)({}, index_1.gaeaHelper.layoutNative, index_1.gaeaHelper.marginPadding, index_1.gaeaHelper.opacity, index_1.gaeaHelper.widthHeight, index_1.gaeaHelper.overflow);
        _this.text = '文字';
        return _this;
    }
