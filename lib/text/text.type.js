...
var PropsGaea = function PropsGaea() {
    ...
    this.gaeaEdit = ['文字', {
        ...
        editor: 'text',
        editable: true
    }, '排版', index_1.gaeaHelper.fontEditor, '布局', index_1.gaeaHelper.marginPaddingEditor, index_1.gaeaHelper.widthHeightEditor, index_1.gaeaHelper.overflowEditor, '特效', index_1.gaeaHelper.opacityEditor];
};
...
var Props = function (_PropsGaea) {
    ...
    function Props() {
        ...
        _this.style = (0, _extends3.default)({}, index_1.gaeaHelper.layoutNative, index_1.gaeaHelper.marginPadding, index_1.gaeaHelper.opacity, index_1.gaeaHelper.widthHeight, index_1.gaeaHelper.overflow, index_1.gaeaHelper.fontNative);
        _this.text = '文字';
        return _this;
    }
